...
<input type="hidden" class="timeE" value="${timeEnd}">`;
    ...
    <div class="sch-event ev-draggable ${opt.classCus.map(cl => `${cl}`).join(' ')}" style="top:${topPosY}px;height:${bottomPosY - topPosY}px">
        ...
        <div class="actions"><a class="fa fa-trash" onclick=removeSch(this)></a><a data-tooltip="tooltip" title="Lorem ipsum dolor sit amet, consectetur adipisicing elit." class="fa fa-cog" onclick=OpenEditMenu(this)></a></div>
